...
<ComboBoxComponent id='choice' placeholder='select a query'
dataSource={sportsData}
fields={{value:"Id", text:"query"}}></ComboBoxComponent>

<DatePickerComponent  id='start' placeholder="Enter start Date"
value={dateValue}
format="dd-MM-yyyy"
></DatePickerComponent>


<DatePickerComponent id='end' placeholder="Enter end Date"
value={dateValue}
format="dd-MM-yyyy"
></DatePickerComponent>
